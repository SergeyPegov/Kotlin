...
abstract class Aircraft(val aircraftNumber: String, val maxFlightRange: Int, val fuelCapacity: Int) {
...
fun main() {
    ...
    //val genericAircraft = Aircraft("IL", 10000, 50000) - Cannot create an instance of an abstract class
